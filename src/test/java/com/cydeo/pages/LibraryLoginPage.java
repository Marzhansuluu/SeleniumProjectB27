...
public class LibraryLoginPage {
    ...
    public LibraryLoginPage(){
        // initElements method will create connections in between the current driver session(instance)
        // and the object of the current class
        PageFactory.initElements(Driver.getDriver(), this);// my object of driver and object of this class.
    }
